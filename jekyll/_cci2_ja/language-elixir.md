...
If you're in a rush, just copy the configuration below into [`.circleci/config.yml`]({{ site.baseurl }}/ja/2.0/configuration-reference/) in your project's root directory. Otherwise, we recommend reading through the whole configuration for better understanding.
...
[Caching Dependencies]({{ site.baseurl }}/ja/2.0/caching/)
[Configuring Databases]({{ site.baseurl }}/ja/2.0/databases/)
