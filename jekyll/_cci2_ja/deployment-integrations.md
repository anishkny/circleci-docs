...
add a [job]({{ site.baseurl }}/ja/2.0/jobs-steps/#jobs-overview) to your `.circleci/config.yml` file.
You will also need to [add environment variables]({{ site.baseurl }}/ja/2.0/env-vars/#setting-an-environment-variable-in-a-project) and [add SSH keys]({{ site.baseurl }}/ja/2.0/add-ssh-key/).
...
The configuration uses [workflows]({{ site.baseurl }}/ja/2.0/workflows/) to deploy only if the `sequential-branch-filter` branch is checked out and the `build` job has run. If your deploy job uses any output from previous jobs, you can share that data by [using workspaces]({{ site.baseurl }}/ja/2.0/workflows/#using-workspaces-to-share-data-among-jobs). For more information on conditional deploys, see [Using Contexts and Filtering in your Workflows]({{ site.baseurl }}/ja/2.0/workflows/#using-contexts-and-filtering-in-your-workflows).
...
see the [Deploying to AWS ECS/ECR document]({{ site.baseurl }}/ja/2.0/ecs-ecr/).
...
Note the use of [workflows]({{ site.baseurl }}/ja/2.0/workflows/)
...
To deploy to Azure, use a similar job to the above example that uses an appropriate command. If pushing to your repo is required, see the [Adding Read/Write Deployment Keys to GitHub or Bitbucket]( {{ site.baseurl }}/ja/2.0/gh-bb-integration/) section of the Github and Bitbucket Integration document for instructions. Then, configure the Azure Web App to use your production branch.
...
Refer to the [Authorizing the Google Cloud SDK]({{ site.baseurl }}/ja/2.0/google-auth/) document for full details.
...
See [Adding Project Environment Variables]({{ site.baseurl }}/ja/2.0/env-vars/#setting-an-environment-variable-in-a-project) for instructions.
...
See [Choosing an Executor Type]({{ site.baseurl }}/ja/2.0/executor-types/) for instructions.
...
For instructions, see the [Adding an SSH Key to CircleCI]({{ site.baseurl }}/ja/2.0/add-ssh-key/) document.

2. Add the SSH username and SSH hostname of your build VM as environment variables.
For instructions, see the [Adding Project Environment Variables]({{ site.baseurl }}/ja/2.0/env-vars/#setting-an-environment-variable-in-a-project) document.
