...
This document provides a walkthrough of the [`.circleci/config.yml`]({{ site.baseurl }}/ja/2.0/configuration-reference/) file for a PHP sample application.
...
- Refer to the [Examples]({{ site.baseurl }}/ja/2.0/examples/) page for more configuration examples of public PHP projects.
