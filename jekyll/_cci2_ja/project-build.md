...
After a software repository on GitHub or Bitbucket is authorized and added as a [project]({{ site.baseurl }}/ja/2.0/glossary/#project) to circleci.com, every code change triggers a [build]({{ site.baseurl }}/ja/2.0/build) and automated tests in a clean container or VM configured for your requirements.
