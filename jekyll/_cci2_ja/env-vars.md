...
5. Context environment variables (assuming the user has access to the Context). See the [Contexts]( {{ site.baseurl }}/ja/2.0/contexts/) documentation for instructions.
...
Store secrets or keys in [project](#setting-an-environment-variable-in-a-project) or [context]({{ site.baseurl }}/ja/2.0/contexts/) settings in the CircleCI app.
For more information,
see the [Encryption section]({{ site.baseurl }}/ja/2.0/security/#encryption) of the "Security" document.

Running scripts within configuration
may expose secret environment variables.
See the [Using Shell Scripts]({{ site.baseurl }}/ja/2.0/using-shell-scripts/#shell-script-best-practices) document for best practices for secure scripts.
...
use the [`environment` key]({{ site.baseurl }}/ja/2.0/configuration-reference/#run).
...
use the [`environment` key]({{ site.baseurl }}/ja/2.0/configuration-reference/#job_name).
...
use the [`environment` key]({{ site.baseurl }}/ja/2.0/configuration-reference/#docker--machine--macosexecutor).
...
see the [Contexts documentation]({{ site.baseurl }}/ja/2.0/contexts/).
...
For an example,
see the [Heroku deploy walkthrough]({{ site.baseurl }}/ja/2.0/deployment-integrations/#heroku).
...
`$CIRCLE_TOKEN` is a [personal API token]({{ site.baseurl }}/ja/2.0/managing-api-tokens/#creating-a-personal-api-token).
...
`CIRCLE_TAG`                | String  | The name of the git tag, if the current build is tagged. For more information, see the [Git Tag Job Execution]({{ site.baseurl }}/ja/2.0/workflows/#executing-workflows-for-a-git-tag).
