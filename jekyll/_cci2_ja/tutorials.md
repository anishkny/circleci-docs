...
Use the tutorial associated with your platform to learn about the customization that is possible in a [`.circleci/config.yml`]({{ site.baseurl }}/ja/2.0/configuration-reference/).

## Tutorials 

Platform Guide | Description
----|----------
<a href="{{ site.baseurl }}/ja/2.0/project-walkthrough/">Linux Project Tutorial</a> | Complete walkthrough of setting up a Python project with Flask to build with CircleCI 2.0.
<a href="{{ site.baseurl }}/ja/2.0/ios-tutorial/">iOS Project Tutorial</a> | Full example of setting up an iOS project in CircleCI 2.0.
<a href="{{ site.baseurl }}/ja/2.0/language-android/">Android Project Tutorial</a> | Full example of setting up an Android project in CircleCI 2.0.
...
Language in which your App is written | Framework | GitHub Repo Name
 ...
 [Python]({{ site.baseurl }}/ja/2.0/project-walkthrough/) | Flask | [circleci-demo-python-flask]
...
[NodeJS - JavaScript]: {{ site.baseurl }}/ja/2.0/language-javascript/
...
<a href="{{ site.baseurl }}/ja/2.0/sample-config/">Sample `config.yml` Files</a> | Four sample `config.yml` files using parallel Workflows, sequential Workflows, fan-in/fan-out Workflows, and building Linux and iOS in one configuration file.
{: class="table table-striped"}
