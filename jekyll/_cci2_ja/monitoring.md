...
Refer to the Shutting Down a Nomad Client section of the [Nomad]({{ site.baseurl }}/ja/2.0/nomad/#shutting-down-a-nomad-client) document for instructions on draining and scaling down the Nomad Clients.
