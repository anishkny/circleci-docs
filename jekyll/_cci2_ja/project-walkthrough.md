...
follow the [instructions]({{ site.baseurl }}/ja/2.0/deployment-integrations/#heroku)
...
see the [Orchestrating Workflows]({{ site.baseurl }}/ja/2.0/workflows) document.
