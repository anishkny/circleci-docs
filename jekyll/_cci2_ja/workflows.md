...
- NEEDS SETUP: A workflow stanza is not included or is incorrect in the [config.yml file]({{ site.baseurl }}/ja/2.0/configuration-reference/) for this project

### Limitations
{:.no_toc}

Projects that have [Build Processing]({{ site.baseurl }}/ja/2.0/build-processing/) enabled may use the CircleCI API to trigger workflows. Projects that do not enable build processing will run as if the workflows did not exist when triggered by the API. **Note:** Builds without workflows require a `build` job.

Refer to the [Workflows]({{ site.baseurl }}/ja/2.0/faq) section of the FAQ for additional information and limitations.

## Workflows Configuration Examples

_For a full specification of the_ `workflows` _key, see the [Workflows]({{ site.baseurl }}/ja/2.0/configuration-reference/#workflows) section of the Configuring CircleCI document._
...
For more details,
see the `branches` section of the [Configuring CircleCI]({{ site.baseurl }}/ja/2.0/configuration-reference/#branches-1) document.
...
The following example shows a workflow with four sequential jobs that use a context to share environment variables. See the [Contexts]({{ site.baseurl }}/ja/2.0/contexts) document for detailed instructions on this setting in the application.
...
- For procedural instructions on how to add Workflows your configuration as you are migrating from a 1.0 `circle.yml` file to a 2.0 `.circleci/config.yml` file, see the [Steps to Configure Workflows]({{ site.baseurl }}/ja/2.0/migrating-from-1-2/) section of the Migrating from 1.0 to 2.0 document. 

- For frequently asked questions and answers about Workflows, see the [Workflows]({{ site.baseurl }}/ja/2.0/faq) section of the  FAQ.
...
- For troubleshooting a workflow with Waiting for Status in GitHub, see [Workflows Waiting for Status in GitHub]({{ site.baseurl }}/ja/2.0/workflows-waiting-status).
