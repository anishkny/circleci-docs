...
See [Creating a Custom Image Manually]({{ site.baseurl }}/ja/2.0/custom-images/#creating-a-custom-image-manually) for more information.
...
set the following [project environment variables]({{ site.baseurl }}/ja/2.0/env-vars/#setting-an-environment-variable-in-a-project).
...
In the `build` job,
use the `docker` [executor]({{ site.baseurl }}/ja/2.0/executor-types/)
and specify the `circleci/golang:1.8` [convenience image]({{ site.baseurl }}/ja/2.0/circleci-images/).
...
Because [`working_directory`]({{ site.baseurl }}/ja/2.0/configuration-reference/#job_name) is unspecified,
the application is checked out to `~/project`.

Use the [`setup_remote_docker`]({{ site.baseurl }}/ja/2.0/configuration-reference/#setup_remote_docker) step
...
Instead, [use `BASH_ENV` to set environment variables]({{ site.baseurl }}/ja/2.0/env-vars/#using-bash_env-to-set-environment-variables).
...
Use [`persist_to_workspace`]({{ site.baseurl }}/ja/2.0/configuration-reference/#persist_to_workspace)
...
Use [`attach_workspace`]({{ site.baseurl }}/ja/2.0/configuration-reference/#attach_workspace)
...
Use [`save_cache`]({{ site.baseurl }}/ja/2.0/configuration-reference/#save_cache) and [`restore_cache`]({{ site.baseurl }}/ja/2.0/configuration-reference/#restore_cache)
...
See the [Caching Dependencies document]({{ site.baseurl }}/ja/2.0/caching/) for more information.
...
See the [Using Workflows to Schedule Jobs]({{ site.baseurl }}/ja/2.0/workflows/) for more information.
