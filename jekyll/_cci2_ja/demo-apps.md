...
Language Guide | Framework | GitHub Repo Name
 ...
 [Python]({{ site.baseurl }}/ja/2.0/project-walkthrough/){:target="_blank"} | Flask | [circleci-demo-python-flask]{:target="_blank"}
...
Refer to the [Getting Started Introduction]({{ site.baseurl }}/ja/2.0/getting-started/) for the steps to run your first build.
...
[Ruby and Rails]: {{ site.baseurl }}/ja/2.0/language-ruby/
