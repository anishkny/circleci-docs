...
[iOS Project Tutorial]({{ site.baseurl }}/ja/2.0/ios-tutorial/).
...
at various points in the build process. See the [Configuring CircleCI]( {{ site.baseurl }}/ja/2.0/configuration-reference/) document for
...
[this doc]({{ site.baseurl }}/ja/2.0/workflows/#workflows-configuration-examples)
