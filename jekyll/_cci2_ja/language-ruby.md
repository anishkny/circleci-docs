...
In this example,
two [CircleCI convenience images]({{ site.baseurl }}/ja/2.0/circleci-images/#image-types) are used:
...
The next section sets up the test database. It uses the `dockerize` [utility](https://github.com/jwilder/dockerize) to delay starting the main process of the [primary container]({{ site.baseurl }}/ja/2.0/glossary/#primary-container) until after the database service is available.
