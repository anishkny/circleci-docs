...
Test suites are conventionally defined at the [job]({{ site.baseurl }}/ja/2.0/jobs-steps/#sample-configuration-with-parallel-jobs) level in your `.circleci/config.yml` file.
...
see the [Configuring CircleCI]({{ site.baseurl }}/ja/2.0/configuration-reference/#parallelism) document.
...
see the [Using the CircleCI Local CLI]({{ site.baseurl }}/ja/2.0/local-cli/) document.
...
specified by the path in the [`store_test_results`]({{ site.baseurl }}/ja/2.0/configuration-reference/#store_test_results) step.
...
currently running.
See the [built-in environment variable documentation]({{ site.baseurl }}/ja/2.0/env-vars/#built-in-environment-variables)
for more details.
