...
This document provides a walkthrough of the [`.circleci/config.yml`]({{ site.baseurl }}/ja/2.0/configuration-reference/) file for a NodeJS sample application.
...
- Refer to the [Examples]({{ site.baseurl }}/ja/2.0/examples/) page for more configuration examples of public Javascript projects.
- If you're new to CircleCI 2.0, we recommend reading our [Project Walkthrough]({{ site.baseurl }}/ja/2.0/project-walkthrough/) for a detailed explanation of our configuration using Python and Flask as an example.
