...
to trigger [jobs]({{ site.baseurl }}/ja/2.0/jobs-steps/#jobs-overview)
...
- `CIRCLE_API_USER_TOKEN` is a [personal API token]({{ site.baseurl }}/ja/2.0/managing-api-tokens/#creating-a-personal-api-token).
...
**Note:**
It is possible to trigger [workflows]({{ site.baseurl }}/ja/2.0/workflows/) with the CircleCI API, using a new endpoint, see the Trigger a Build by Project section of the [CircleCI API Projects Documentation]({{ site.baseurl }}/api/v1-reference/#new-project-build).
...
created for [a CircleCI Context]({{ site.baseurl }}/ja/2.0/contexts/).
Instead, define these variables at the [Project level]({{ site.baseurl }}/ja/2.0/env-vars/#setting-an-environment-variable-in-a-project).
...
[Triggers]({{ site.baseurl }}/ja/2.0/triggers/)
