...
This document provides example database [config.yml]({{ site.baseurl }}/ja/2.0/databases/) files using PostgreSQL/Rails and MySQL/Ruby in the following sections:
...
Refer to the [Go Language Guide]({{ site.baseurl }}/ja/2.0/language-go/) for a walkthrough of this example configuration and a link to the public code repository for the app.
