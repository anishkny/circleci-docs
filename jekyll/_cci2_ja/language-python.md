...
Every CircleCI project requires a configuration file called [`.circleci/config.yml`]({{ site.baseurl }}/ja/2.0/configuration-reference/).
Follow the steps below
to create a complete `config.yml` file.

### Specify a Version

Every `config.yml` starts with the [`version`]({{ site.baseurl }}/ja/2.0/configuration-reference/#version) key.
This key is used
...
A run is comprised of one or more [jobs]({{ site.baseurl }}/ja/2.0/configuration-reference/#jobs).
Because this run does not use [workflows]({{ site.baseurl }}/ja/2.0/configuration-reference/#workflows),
it must have a `build` job.

Use the [`working_directory`]({{ site.baseurl }}/ja/2.0/configuration-reference/#job_name) key
to specify where a job's [`steps`]({{ site.baseurl }}/ja/2.0/configuration-reference/#steps) run.
By default,
...
The steps of a job occur in a virtual environment called an [executor]({{ site.baseurl }}/ja/2.0/executor-types/).

In this example,
the [`docker`]({{ site.baseurl }}/ja/2.0/configuration-reference/#docker) executor is used
to specify a custom Docker image.
The first image listed becomes the job's [primary container]({{ site.baseurl }}/ja/2.0/glossary/#primary-container).
...
**Note:**
`circleci/python:3.6.4` is a [convenience image]({{ site.baseurl }}/ja/2.0/circleci-images/) provided by CircleCI.
...
Use the [`environment`]({{ site.baseurl }}/ja/2.0/env-vars/#setting-an-environment-variable-in-a-container) key
...
create [`steps`]({{ site.baseurl }}/ja/2.0/configuration-reference/#steps) to run specific commands.

Use the [`checkout`]({{ site.baseurl }}/ja/2.0/configuration-reference/#checkout) step
to check out source code.
By default,
source code is checked out to the path specified by `working_directory`.

Use the [`run`]({{ site.baseurl }}/ja/2.0/configuration-reference/#run) step
...
consider [caching dependencies or source code]({{ site.baseurl }}/ja/2.0/caching/).

Use the [`save_cache`]({{ site.baseurl }}/ja/2.0/configuration-reference/#save_cache) step
to cache certain files or directories.
In this example,
the virtual environment and installed packages are cached.

Use the [`restore_cache`]({{ site.baseurl }}/ja/2.0/configuration-reference/#restore_cache) step
...
Use the [`store_test_results`]({{ site.baseurl }}/ja/2.0/configuration-reference/#store_test_results) step
to upload test results to CircleCI.
These results will display in the **Test Summary** section of the CircleCI application.

Use the [`store_artifacts`]({{ site.baseurl }}/ja/2.0/configuration-reference/#store_artifacts) step
...
See the [Flask Project Walkthrough]({{ site.baseurl }}/ja/2.0/project-walkthrough/) or the [Deploy]({{ site.baseurl }}/ja/2.0/deployment-integrations/) document for deploy examples.
...
- See the [Tutorials page]({{ site.baseurl }}/ja/2.0/tutorials/) for other language guides.
