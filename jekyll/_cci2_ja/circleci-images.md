...
making it the [primary container]({{ site.baseurl }}/ja/2.0/glossary/#primary-container){:target="_blank"} during execution.
...
See [Using Private Images]({{ site.baseurl }}/ja/2.0/private-images/) for information about how to authorize your build to use an image in a private repository or in Amazon ECR.
