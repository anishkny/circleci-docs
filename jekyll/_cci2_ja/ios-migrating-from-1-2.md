...
You can see all the available step types in the [Configuring CircleCI]({{ site.baseurl }}/ja/2.0/configuration-reference/) document.
...
Please check out [this doc]({{ site.baseurl }}/ja/2.0/caching/) for
...
Refer to the [Orchestrating Workflows doc]({{ site.baseurl }}/ja/2.0/workflows/)
