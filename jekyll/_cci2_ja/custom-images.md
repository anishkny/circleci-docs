...
If the [CircleCI convenience images]({{ site.baseurl }}/ja/2.0/circleci-images/) do not suit your needs,
...
reduces the number of lines in your [`config.yml`]({{ site.baseurl }}/ja/2.0/configuration-reference/) file.
...
The following sections provide a walkthrough of how to create a custom image manually. In most cases you'll want to have a custom image for your [primary container]({{ site.baseurl }}/ja/2.0/glossary/#primary-container) so that is the focus of this document. But, you can easily apply this knowledge to create images for supporting containers as well.
...
**Note:** To use an image with the CircleCI [Docker Executor]({{ site.baseurl }}/ja/2.0/executor-types) you must have a public repository. If you want to keep your image private refer to the [Using Private Images and Repositories]({{ site.baseurl }}/ja/2.0/private-images/) document for instructions.
