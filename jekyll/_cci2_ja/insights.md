...
Refer to the [Collecting Test Metadata]({{ site.baseurl }}/ja/2.0/collect-test-data/) document for instructions to configure insights into your most failed tests.
